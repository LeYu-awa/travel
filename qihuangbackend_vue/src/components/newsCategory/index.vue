<template>
  <div :style="{ height: scrollerHeight + 'px' || ''}">
    <div class="filter-container">
      <div class="container">
          <el-form :model="formValidate" ref="searchForm" :inline="true" size="small" @submit.native.prevent>
            <el-form-item label="图文搜索：" prop="cate_name">
              <el-input v-model="formValidate.cate_name" @keyup.enter.native="userSearchs" placeholder="请输入内容" class="selWidth" @change="userSearchs" />
            </el-form-item>
            <el-form-item>
