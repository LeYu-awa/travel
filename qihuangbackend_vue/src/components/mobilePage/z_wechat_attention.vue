<template>
    <div class="mobile-page">
        <div class="flex-box" :style="{marginLeft:prConfig+'px',marginRight:prConfig+'px',background:bgColor,marginTop:mTOP+'px'}">
            <div class="left">
                <div class="img-box">
