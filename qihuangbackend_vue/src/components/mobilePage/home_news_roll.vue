<template>
    <div class="news-box" :class="{pageOn:bgStyle===1}" :style="{margin:'0 '+prConfig+'px',marginTop:slider+'px',background:bgColor}" v-if="list.length">
    ...
    data () {
        return {
            ...
            defaultConfig: {
                ...
                listConfig: {
                    title: '最多可添加10个板块；鼠标拖拽左侧圆点可调整版块顺序',
                    max: 10,
                    list: [
                        {
                            chiild: [
