      ...
      <div class="main" v-loading="loading">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="网络图片：" prop="region" v-if="ruleForm.type == 1">
            <el-input class="form-width" v-model="webImgUrl" placeholder="请填写网络图片地址"></el-input>
            ...
            <div class="acea-row">
              <div class="uploadCont">
                ...
                >
                  ...
                  >
                   <!-- {{['png','jpg','gif','jepg','svg'].indexOf(file.name.substr(file.name.lastIndexOf('.')+1))}} -->
                    
                    <img class="el-upload-list__item-thumbnail" :src="file.url" alt="" />
                    <i class="el-icon-error btndel" @click="handleWebRemove(file)" />
                  </div>
                </el-upload>
                <div class="tips">一次最多上传50张，建议上传图片最大宽度750px，不超过5MB；仅支持jpeg、png格式，可拖拽调整上传顺序</div>
              </div>
            </div>
          </el-form-item>
