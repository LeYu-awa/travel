<template>
  <div class="divBox" style="background: #F0F2F5;">
    <base-info v-if="is_area == 0" ref="baseInfo" class="mb15" />
    <todo-panel v-if="is_area == 0" ref="todoPanel" />
    <to-day class="mb15" />
                ...
                return h("div", [
                  h(
                    "a",
                    {
                      attrs: {
                        href:
                          "http://www.qihuang.com/home/grant/applyauthorize.html",
                        target: "_blank"
                      }
                    },
                    res.message
            ...
            if (res.data.status == 201) {
              ...
              let url = res.data.result.url,
                message =
                  ...
                  '<br/><a href="' +
                  url +
                  '" style="color: #4073FA;font-size: 14px; "target="_blank">' +
                  res.data.result.msg +
                  "</a>";
              return this.$notify.warning({
                title: "温馨提示",
