<template>
  <div>
    ...
    >
      <div v-loading="loading">
        <div class="head">
          ...
          <ul class="list">
            <li class="item">
              ...
              <div>
                <div v-if="!orderDetailList.pay_time" class="value1">待付款</div>
        ...
        <el-tabs type="border-card" v-model="activeName" @tab-click="tabClick">
          <el-tab-pane label="订单信息" name="detail">
            <template v-if="activeName == 'detail'">
              <div class="section">
                ...
                <ul v-if="orderDetailList.user" class="list">
                  <li class="item">
                    <div>用户昵称：</div>
                    <div class="value">
                      {{
          ...
          <el-tab-pane label="订单记录" name="orderList">
            <div v-if="activeName == 'orderList'">
              <el-form size="small" label-width="90px">
                <div class="acea-row">
                  <el-form-item label="操作端：" class="mr10">
                    <el-select
          ...
          <el-tab-pane label="店铺信息" name="merchant">
            <template v-if="activeName == 'merchant'">
              <div class="section">
                <div class="title">店铺信息</div>
              <ul v-if="orderDetailList.merchant" class="list">
                  <li class="item">
                    <div>商户名称：</div>
                    <div class="value">{{ orderDetailList.merchant.mer_name }}</div>
                  </li>
                  <li class="item">
                    <div>商户类型：</div>
                    <div class="value">{{ orderDetailList.merchant.type_name }}</div>
                  </li>
                <li class="item">
                    <div>商户类别：</div>
    ...
    >
      ...
      <div v-if="result.length>0" class="acea-row row-column-around trees-coadd">
        <div class="scollhide">
          <el-timeline>
