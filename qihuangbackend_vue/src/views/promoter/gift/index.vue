    ...
    <div class="selCard">
      <el-form :model="tableFrom" ref="searchForm" inline size="small" label-width="85px">
        ...
        <el-form-item label="商品搜索：" prop="keyword">
          <el-input v-model="tableFrom.keyword" @keyup.enter.native="getList(1)" placeholder="请输入商品名称，关键字，产品编号" class="selWidth" clearable />
        </el-form-item>
        <el-form-item>
    ...
    <el-card class="mt14">
      ...
      >
        ...
        <el-table-column
          ...
          min-width="150"
        />
        <el-table-column v-if="Number(tableFrom.type) < 7" key="8" label="操作" min-width="130" fixed="right">
          <template slot-scope="scope">
    ...
    >
      <el-form ref="formValidate" v-loading="fullscreenLoading" class="formValidate mt20" :rules="ruleValidate" :model="formValidate" label-width="100px" @submit.native.prevent>
        ...
        <el-form-item label="排序：">
          <el-input-number v-model="formValidate.rank" label="已售数量" />
        </el-form-item>
        <el-col :span="24">
