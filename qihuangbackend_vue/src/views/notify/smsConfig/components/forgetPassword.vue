<template>
    <el-row justify="center" align="middle">
        <el-col :span="24" style="margin-top: 70px;" class="mb50">
            ...
            <div class="index_from page-account-container">
                <el-form ref="formInline" :model="formInline" :rules="ruleInline" @submit.native.prevent>
                    <template v-if="current === 0">
                        <el-form-item class="maxInpt" prop="phone">
                            <el-input type="text" v-model="formInline.phone" prefix="ios-contact-outline"
                                   placeholder="请输入手机号" size="small"/>
                        </el-form-item>
                        <el-form-item prop="verify_code" class="maxInpt">
                            <div class="code">
                                <el-input type="text" v-model="formInline.verify_code" prefix="ios-keypad-outline"
                                       placeholder="请输入验证码" size="small" />
                                <el-button :disabled=!this.canClick @click="cutDown" size="small" style="width: 100px;">{{cutNUm}}</el-button>
                            </div>
                        </el-form-item>
                    </template>
                    <template v-if="current === 1">
                        <el-form-item prop="password" class="maxInpt">
                            <el-input type="password" v-model="formInline.password" prefix="ios-lock-outline"
                                   placeholder="请输入新密码" size="small"/>
                        </el-form-item>
                        <el-form-item prop="checkPass" class="maxInpt">
                            <el-input type="password" v-model="formInline.checkPass" prefix="ios-lock-outline"
                                   placeholder="请验证新密码" size="small"/>
                        </el-form-item>
                    </template>
                    <template v-if="current === 2">
                        <el-form-item prop="phone" class="maxInpt">
                            <el-input type="text" v-model="formInline.phone" prefix="ios-contact-outline"
                                   placeholder="请输入手机号" size="small" disabled/>
                        </el-form-item>
                        <el-form-item prop="password" class="maxInpt">
                            <el-input type="password" v-model="formInline.password" size="small" prefix="ios-lock-outline"
                                   placeholder="请输入密码"/>
                        </el-form-item>
                    </template>
                    <el-form-item class="maxInpt">
                        <el-button v-if="current === 0" type="primary" size="small" @click="handleSubmit1('formInline',current)" class="mb20">下一步</el-button>
                        <el-button v-if="current === 1" type="primary" size="small" @click="handleSubmit2('formInline',current)" class="mb20">提交</el-button>
                        <el-button v-if="current === 2" type="primary" @click="handleSubmit('formInline',current)" class="mb20">登录</el-button>
                        <el-button @click="returns('formInline')" size="small" class="btn">返回</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </el-col>
