...
import { efficacyList, efficacyDelete } from "@/api/content";
      ...
      switch (name) {
        ...
        case "del":
          this.$confirm("是否删除此数据?", "提示", {
            ...
            this.IfefficacyDelete(row.id);
          });
          break;
      }
    },
    // 删除接口
    IfefficacyDelete(str) {
      efficacyDelete(str).then(res => {
        this.$message({
          type: "success",
          message: "删除成功!"
        });
