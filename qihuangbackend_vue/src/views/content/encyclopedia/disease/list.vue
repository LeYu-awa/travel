...
import { diseaseList,diseaseDelete, diseaseEdit } from '@/api/content'
  ...
  data() {
    return {
      ...
      tableHeaderData: [
        ...
        { prop: 'summary', label: '概要', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'cause', label: '病因', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'diagnosis', label: '诊断', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'dialectics', label: '辨证', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'acupuncture', label: '针灸', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'comment', label: '按语', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'treatment', label: '治疗', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'prognosis', label: '预后', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'massage', label: '推拿', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'moxibustion', label: '灸法', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'medical_case', label: '医案', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'anmo', label: '按摩', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'custom', label: '其他', columnType: 'text', align: 'left', 'min-width': '249' },
