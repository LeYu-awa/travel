...
<script>
import { medicinalDietEfficacyAdd, medicinalDietEfficacyEdit } from "@/api/content";
...
export default {
  ...
  methods: {
    ...
    onSubmitForm() {
      this.fApi.submit((formData, fApi) => {
        if (formData.id) {
          ...
          this.IfaddmedicinalDietEfficacyAdd(formData);
        }
      });
    },
    cancel() {
    ...
    IfaddmedicinalDietEfficacyAdd(data) {
      medicinalDietEfficacyAdd(data).then(res => {
        this.$emit("confirm");
      });
    },
    IfupdateEditGift(data) {
      medicinalDietEfficacyEdit(data).then(res => {
        this.$emit("confirm");
      });
    }
  }
