...
import { termList,termDelete, termEdit } from '@/api/content'
  ...
  data() {
    return {
      ...
      tableHeaderData: [
        ...
        { prop: 'name', label: '术语名称', columnType: 'text', align: 'left', 'min-width': '249' },
        // { prop: 'initial', label: '首字母', columnType: 'text', align: 'left', 'min-width': '249' },
        // { prop: 'money', label: '专题数量', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'category', label: '类别', columnType: 'text', align: 'left', 'min-width': '120' },
        { prop: 'concept', label: '概念', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'explanation', label: '解读', columnType: 'text', align: 'left', 'min-width': '249' },
        // { prop: 'application', label: '应用领域', columnType: 'text', align: 'left', 'min-width': '249' },
        // { prop: 'reference', label: '参考文献', columnType: 'text', align: 'left', 'min-width': '249' },
        // { prop: 'description', label: '描述', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'is_show', label: '是否显示', columnType: 'switch', align: 'left', 'min-width': '249' },
        { prop: 'create_time', label: '创建时间', columnType: 'text', align: 'left', 'min-width': '160' },
        { prop: 'update_time', label: '更新时间', columnType: 'text', align: 'left', 'min-width': '160' },
