...
import { acupointList, acupointDelete } from "@/api/content";
      ...
      switch (name) {
        ...
        case "del":
          this.$confirm("是否删除此数据?", "提示", {
            ...
            this.IfacupointDelete(row.id);
          });
          break;
      }
    },
    // 删除接口
    IfacupointDelete(str) {
      acupointDelete(str).then(res => {
        this.$message({
          type: "success",
          message: "删除成功!"
        });
