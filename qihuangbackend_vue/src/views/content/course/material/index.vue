...
import { materialList, materialDelete, materialEdit } from '@/api/content'
  ...
  data() {
    return {
      ...
      tableHeaderData: [
        ...
        { prop: 'type', label: '分类', columnType: 'slot', align: 'left', 'min-width': '249' },
        { prop: 'cover_image', label: '封面图片', columnType: 'image', align: 'left', 'min-width': '249' },
        { prop: 'description', label: '素材简介', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'content', label: '素材内容', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'file_url', label: '文件地址', columnType: 'text', align: 'left', 'min-width': '249' },
        // { prop: 'file_size', label: '文件大小', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'duration', label: '时长', columnType: 'text', align: 'left', 'min-width': '249' },
        { prop: 'is_need_pay', label: '是否付费', columnType: 'switch', align: 'left', 'min-width': '249' },
