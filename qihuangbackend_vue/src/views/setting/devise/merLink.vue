    ...
    <el-card>
     <div class="mb20">
      ...
      >
        ...
        <el-table-column prop="url" label="页面链接" min-width="150" />
...
<script>
import {
  merLinkList, addMerLink, editMerLink, deleteMerLink, merLinkStatus
} from "@/api/diy";
export default {
  name: "MerchantLink",
  data() {
  ...
  methods: {  
    ...
    onchangeIsShow(row) {
      merLinkStatus(row.id, row.status).then(({ message }) => {
