      ...
      >
        <el-form-item label="优惠券类型：" prop="type">
          ...
          >
            ...
            <el-option label="直播券" :value="13" />
            <el-option label="视频券" :value="14" />
          </el-select>
        </el-form-item>
            ...
            <div class="section">
              ...
              <ul class="list">
                ...
                <li class="item">
                  ...
                  <div class="value" v-if="couponDetail.type == 13">直播券</div>
                  <div class="value" v-if="couponDetail.type == 14">视频券</div>
                </li>
                <li class="item">
                  <div>优惠券面值：</div>
                ...
                <li class="item">
                  ...
                  <div
                    class="value"
                    v-if="
                      couponDetail.coupon_time && couponDetail.coupon_type == 0
                    "
                  >
                    {{ couponDetail.coupon_time }}天
                  </div>
                  <div class="value" v-else-if="couponDetail.coupon_type == 1">
                    {{
                      couponDetail.use_start_time +
                        " - " +
                        couponDetail.use_end_time
                    }}
                  </div>
                </li>
                <li class="item">
                ...
                <li class="item">
                  <div>获取方式：</div>
                  <div v-if="couponDetail.send_type == 0" class="value">
                    手动领取
                  </div>
                  <div v-else-if="couponDetail.send_type == 1" class="value">
                    消费满赠券
                  </div>
                  <div v-else-if="couponDetail.send_type == 2" class="value">
                    新人券
                  </div>
                  <div v-else-if="couponDetail.send_type == 3" class="value">
                    买赠券
                  </div>
                  <div v-else-if="couponDetail.send_type == 4" class="value">
                    首单赠送券
                  </div>
                  <div v-else-if="couponDetail.send_type == 5" class="value">
                    会员赠送券
                  </div>
                </li>
                <li class="item">
                  <div>类型：</div>
                  <div class="value">
                    {{ couponDetail.type | couponUseTypeFilter }}
                  </div>
                </li>
                <li class="item">
                  <div>是否限量：</div>
