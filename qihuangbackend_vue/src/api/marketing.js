...
export function getLiveType() {
    return request.get(`community/topic/getLiveType`)
}

export function deleteLiveType(id) {
    return request.get(`community/topic/deleteLiveType?id=${id}`)
}

export function addLiveType(data) {
    return request.get(`community/topic/addLiveType?name=${data.name}&sort=${data.sort}&logo=${data.logo}`)
}

export function editLiveType(data) {
    return request.get(`community/topic/editLiveType?name=${data.name}&sort=${data.sort}&id=${data.id}&logo=${data.logo}`)
}

/**
 * @description 健康管理  --  视频管理 -- 病症 -- 列表
 */
export function healthSymptomList(data) {
    return request.get("community/topic/healthSymptomList", data);
}

/**
 * @description 健康管理  --  视频管理 -- 病症 -- 编辑
 */
export function healthSymptomEdit(data) {
    return request.post("community/topic/healthSymptomEdit/" + data.id, data);
}

/**
 * @description 健康管理  --  视频管理 -- 病症 -- 删除
 */
export function healthSymptomDelete(id) {
    return request.post("community/topic/healthSymptomDelete/" + id);
}

/**
 * @description 健康管理  --  视频管理 -- 病症 -- 添加
 */
export function healthSymptomAdd(data) {
    return request.post("community/topic/healthSymptomAdd", data);
}

/**
 * @description 健康管理  --  视频管理 -- 列表 -- 列表
 */
export function healthVideoCourseList(data) {
    return request.get("community/topic/healthVideoCourseList", data);
}

/**
 * @description 健康管理  --  视频管理 -- 列表 -- 编辑
 */
export function healthVideoCourseEdit(data) {
    return request.post("community/topic/healthVideoCourseEdit/" + data.id, data);
}

/**
 * @description 健康管理  --  视频管理 -- 列表 -- 删除
 */
export function healthVideoCourseDelete(id) {
    return request.post("community/topic/healthVideoCourseDelete/" + id);
}

/**
 * @description 健康管理  --  视频管理 -- 列表 -- 添加
 */
export function healthVideoCourseAdd(data) {
    return request.post("community/topic/healthVideoCourseAdd", data);
}



/**
 * @description 健康管理  --  订单管理  -- 列表
 */
export function healthVideoOrderList(data) {
    return request.get("community/topic/healthVideoOrderList", data);
}

/**
 * @description 健康管理  --  订单管理 -- 编辑
 */
export function healthVideoOrderEdit(data) {
    return request.post("community/topic/healthVideoOrderEdit/" + data.id, data);
}

/**
 * @description 健康管理  --  订单管理  -- 删除
 */
export function healthVideoOrderDelete(id) {
    return request.delete("community/topic/healthVideoOrderDelete/" + id);
}


/**
 * @description 健康管理  --  视频卡  -- 列表
 */
export function healthVideoMemberCardList(data) {
    return request.get("community/topic/healthVideoMemberCardList", data);
}

/**
 * @description 健康管理  --  视频卡 -- 编辑
 */
export function healthVideoMemberCardEdit(data) {
    return request.post("community/topic/healthVideoMemberCardEdit/" + data.id, data);
}

/**
 * @description 健康管理  --  视频卡 -- 删除
 */
export function healthVideoMemberCardDelete(id) {
    return request.delete("community/topic/healthVideoMemberCardDelete/" + id);
}

/**
 * @description 健康管理  --  视频卡 -- 添加
 */
export function healthVideoMemberCardAdd(data) {
    return request.post("community/topic/healthVideoMemberCardAdd", data);
}

/**
 * @description 健康管理  --  公告  -- 列表
 */
export function storeNoticeList(data) {
    return request.get("community/topic/storeNoticeList", data);
}

/**
 * @description 健康管理  --  公告 -- 编辑
 */
export function storeNoticeEdit(data) {
    return request.post("community/topic/storeNoticeEdit/" + data.id, data);
}

/**
 * @description 健康管理  --  公告 -- 删除
 */
export function storeNoticeDelete(id) {
    return request.delete("community/topic/storeNoticeDelete/" + id);
}

/**
 * @description 健康管理  --  公告 -- 添加
 */
export function storeNoticeAdd(data) {
    return request.post("community/topic/storeNoticeAdd", data);
}


/**
 * @description 健康管理  --  专科直播预约管理  -- 列表
 */
export function liveAppointmentList(data) {
    return request.get("community/topic/liveAppointmentList", data);
}

/**
 * @description 健康管理  --  专科直播预约管理 -- 编辑
 */
export function liveAppointmentEdit(data) {
    return request.post("community/topic/liveAppointmentEdit/" + data.id, data);
}

/**
 * @description 健康管理  --  专科直播预约管理 -- 删除
 */
export function liveAppointmentDelete(id) {
    return request.delete("community/topic/liveAppointmentDelete/" + id);
}

/**
 * @description 健康管理  --  专科直播预约管理 -- 添加
 */
export function liveAppointmentAdd(data) {
    return request.post("community/topic/liveAppointmentAdd", data);
}



/**
 * @description 健康管理  --  身体部位管理  -- 列表
 */
export function bodyPartList(data) {
    return request.get("community/topic/bodyPartList", data);
}

/**
 * @description 健康管理  --  身体部位管理 -- 编辑
 */
export function bodyPartEdit(data) {
    return request.post("community/topic/bodyPartEdit/" + data.id, data);
}

/**
 * @description 健康管理  --  身体部位管理 -- 删除
 */
export function bodyPartDelete(id) {
    return request.delete("community/topic/bodyPartDelete/" + id);
}

/**
 * @description 健康管理  --  身体部位管理 -- 添加
 */
export function bodyPartAdd(data) {
    return request.post("community/topic/bodyPartAdd", data);
}
 ...
 * @description 投票活动 -- 列表
 */
export function voteListApi(data) {
    return request.get('activity/vote/lst', data)
}

/**
 * @description 投票活动 -- 详情
 */
export function voteDetailApi(id) {
    return request.get(`activity/vote/detail/${id}`)
}

/**
 * @description 投票活动 -- 创建表单
 */
export function voteCreateFormApi() {
    return request.get('activity/vote/create/form')
}

/**
 * @description 投票活动 -- 创建
 */
export function voteCreateApi(data) {
    return request.post('activity/vote/create', data)
}

/**
 * @description 投票活动 -- 编辑表单
 */
export function voteUpdateFormApi(id) {
    return request.get(`activity/vote/update/${id}/form`)
}

/**
 * @description 投票活动 -- 编辑
 */
export function voteUpdateApi(id, data) {
    return request.post(`activity/vote/update/${id}`, data)
}

/**
 * @description 投票活动 -- 修改状态
 */
export function voteStatusApi(id, status) {
    return request.post(`activity/vote/status/${id}`, { status })
}

/**
 * @description 投票活动 -- 删除
 */
export function voteDeleteApi(id) {
    return request.delete(`activity/vote/delete/${id}`)
}

/**
 * @description 投票选手 -- 列表
 */
export function votePlayerListApi(data) {
    return request.get('activity/vote/player/lst', data)
}

/**
 * @description 投票选手 -- 审核
 */
export function votePlayerAuditApi(id, data) {
    return request.post(`activity/vote/player/audit/${id}`, data)
}

/**
 * @description 投票记录 -- 列表
 */
export function voteRecordListApi(data) {
    return request.get('activity/vote/record/lst', data)
}

/**
 * @description 投票活动 -- 统计
 */
export function voteStatisticsApi(id) {
    return request.get(`activity/vote/statistics/${id}`)
}

/**
 * @description 注册赠送 -- 获取配置
 */
export function getRegisterGiveConfig() {
    return request.get('user/register_give/config')
}
/**
 * @description 注册赠送 -- 保存配置
 */
export function saveRegisterGiveConfig(data) {
    return request.post('user/register_give/config', data)
}
