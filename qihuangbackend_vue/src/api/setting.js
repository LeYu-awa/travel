 ...
 * @param {Object} param params {Object} 传值参数
 */
export function adminCreateFormApi() {
...
export function adminCreateApi(data) {
  return request.post(`/system/admin/create`, data);
}
 ...
 * @param {Object} param params {Object} 传值参数
 */
export function adminUpdateFormApi(id) {
 ...
 * @param {Object} param params {Object} 传值参数
 */
export function adminUpdateApi(data) {
  return request.post(`system/admin/update/${data.admin_id}`, data);
}
...
export function scanUploadSave(scan_token, data) {
  return request.post(
    `system/attachment/scan_upload/image/${scan_token}`,
    data
  );
}
/**
 ...
 * @description 获取轮播列表
 */
export function getCarouse(data) {
  return request.get(`community/topic/getCarouse`, data);
}
/**
 * @description 删除轮播图
 */
export function deleteCarouse(data) {
  return request.get(`community/topic/deleteCarouse`, data);
}
...
export function addCarouse(data) {
  return request.get(`community/topic/addCarouse`, data);
}

/**
 * @description 编辑轮播图
 */
export function editCarouse(data) {
  return request.get(`community/topic/editCarouse`, data);
}

export function getHeadConfig() {
  return request.get(`community/topic/getHeadConfig`);
}

export function deleteHeadConfig(id) {
  return request.get(`community/topic/deleteHeadConfig?id=${id}`);
}

export function addHeadConfig(data) {
  return request.get(`community/topic/addHeadConfig`, data);
}

export function editHeadConfig(data) {
  return request.get(`community/topic/editHeadConfig`, data);
}

export function areaAdminList(data) {
  return request.get("community/topic/areaAdminList", data);
}

export function areaAdminEdit(data) {
  return request.post("community/topic/areaAdminEdit/" + data.area_id, data);
}
export function areaAdminDelete(id) {
  return request.post("community/topic/areaAdminDelete/" + id);
}

export function areaAdminAdd(data) {
  return request.post("community/topic/areaAdminAdd", data);
}
export function areaAdminChangePwd(data) {
  return request.post("community/topic/areaAdminChangePwd/" + data.id, data);
}
