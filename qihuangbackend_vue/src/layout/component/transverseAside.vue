...
.el-menu-horizontal-warp ::v-deep .el-scrollbar__bar.is-vertical {
  display: none;
}
.el-menu-horizontal-warp ::v-deep .el-scrollbar__wrap {
  overflow-y: hidden !important;
  overflow-x: scroll !important;
}
.el-menu-horizontal-warp ::v-deep a {
  width: 100%;
}
...
@media (max-width: 1500px) {
  .layout-columns-tra-aside ul .columns-card,
  .layout-columns-tra-aside ul li,
  .layout-columns-tra-aside ul li .columns-horizontal{
    width: 60px;
  }
}
::v-deep .el-scrollbar {
