      ...
      >
        ...
        <div v-show="currentTab === 1">
          ...
          <el-row :gutter="24">
            <el-col v-bind="grid2">
              <el-form-item label="秒杀商品关键字：">
                <el-input v-model="formValidate.keyword" size="small" placeholder="请输入商品关键字" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24">
          ...
          <el-row :gutter="24">
            ...
            <el-col v-bind="grid2">
              <el-form-item label="活动日期内最多购买件数：" prop="all_pay_count" label-width="210px">
                <el-input-number v-model="formValidate.all_pay_count" size="small" />
              </el-form-item>
            </el-col>
            <el-col v-bind="grid2">
            ...
            <el-col v-bind="grid2">
              <el-form-item label="秒杀时间段内最多购买件数：" prop="once_pay_count" label-width="210px">
                <el-input-number v-model="formValidate.once_pay_count" size="small" />
              </el-form-item>
            </el-col>
            <el-col v-bind="grid2">
            ...
            <el-col v-if="(formValidate.delivery_free == 0 && ((formValidate.delivery_way.length == 2) || (formValidate.delivery_way.length == 1 && formValidate.delivery_way[0] == 2)) && formValidate.type == 0)" :span="24">
              <el-form-item label="运费模板：" prop="temp_id">
                <div class="acea-row">
                  ...
                  <el-button size="small" @click="addTem">添加运费模板</el-button>
                </div>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
              <el-form-item label="平台保障服务：">
                <div class="acea-row">
                  ...
                  <el-button size="small" @click="addServiceTem">添加服务说明模板</el-button>
                </div>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <!--系统表单-->
          <el-row v-if="formData.length>0 && currentTab===1 && formValidate.mer_form_id">
            <el-col>
