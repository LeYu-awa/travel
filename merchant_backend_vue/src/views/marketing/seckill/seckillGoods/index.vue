    ...
    <div class="selCard">
      <el-form :model="tableFrom" ref="searchForm" size="small" label-width="85px" :inline="true">
        ...
        <el-form-item label="关键字：" prop="keyword">
          <el-input v-model="tableFrom.keyword" placeholder="请输入商品名称，关键字，产品编号" clearable class="selWidth" @keyup.enter.native="getList(1)" />
        </el-form-item>
        <el-form-item>
      ...
      seckillDetailApi(id).then(async(res) => {
        ...
        this.formValidate = {
          ...
          end_day: info.seckillActive && info.seckillActive.end_day
            ...
            : '',
          mer_labels_data: info.mer_labels_data,
