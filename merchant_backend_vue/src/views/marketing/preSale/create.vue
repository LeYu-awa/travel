        ...
        <div v-show="currentTab === 1">
          ...
          <el-row :gutter="24">
            ...
            <el-col :span="24">
              <el-form-item label="发货时间：" prop="delivery_type">
                <div class="acea-row">
                  <el-select v-if="formValidate.presell_type === 1" v-model="formValidate.delivery_type" size="small" placeholder="请选择" class="selWidthd1 mr20">
                  ...
                  <el-input-number v-model="formValidate.delivery_day" :min="1" placeholder="请输入天数" size="small" class="mr10" /> 天之内
                </div>
              </el-form-item>
            </el-col>
            <el-col v-bind="grid2">
              <el-form-item label="限购：">
                <el-input-number v-model="formValidate.pay_count" :min="0" placeholder="请输入数量" size="small" class="mr10" />  默认“0” ，为不限制购买数量
              </el-form-item>
            </el-col>
            <el-col v-bind="grid2">
            ...
            <el-col v-if="(formValidate.delivery_free == 0 && ((formValidate.delivery_way.length == 2) || (formValidate.delivery_way.length == 1 && formValidate.delivery_way[0] == 2))) && formValidate.type == 0" :span="24">
              <el-form-item label="运费模板：" prop="temp_id">
                <div class="acea-row">
                  <el-select v-model="formValidate.temp_id" placeholder="请选择" size="small" class="selWidthd mr20">
            ...
            <el-col v-if="labelList.length" :span="24">
              <el-form-item label="商品标签：">
                <el-select v-model="formValidate.mer_labels" multiple placeholder="请选择" size="small" class="selWidthd">
                  <el-option
            ...
            <el-col :span="24">
              <el-form-item label="平台保障服务：">
                <div class="acea-row">
                  <el-select v-model="formValidate.guarantee_template_id" placeholder="请选择" size="small" clearable class="selWidthd mr20">
                    <el-option
              ...
              <el-form-item v-if="formValidate.spec_type === 0" label="规格列表：">
                <el-table :data="OneattrValue" border class="tabNumWidth" size="mini">
                  ...
                  <el-table-column align="center" label="预售价" min-width="80">
                    <template slot-scope="scope">
                      <el-input v-model.number="scope.row['presell_price']" type="number" size="small" class="priceBox" :min="0" :max="scope.row['price']" @blur="limitPrice(scope.row)" />
                    </template>
                  </el-table-column>
                  <el-table-column v-if="formValidate.presell_type === 2" align="center" label="预售定金" min-width="80">
                    <template slot-scope="scope">
                      <el-input @input="handleInput(scope.row['down_price'])" v-model="scope.row['down_price']" size="small" type="number" class="priceBox" :min="0" :max="scope.row['price']*0.2" @blur="restrictedRange(scope.row)" />
                    </template>
                  </el-table-column>
                  ...
                  <el-table-column align="center" label="限量" min-width="80">
                    <template slot-scope="scope">
                      <el-input v-model.number="scope.row['stock']" type="number" size="small" class="priceBox" :max="scope.row['old_stock']" :min="0" @change="limitInventory(scope.row)" />
                    </template>
                  </el-table-column>
          ...
          <el-row :gutter="24">
            <el-form-item v-if="formValidate.spec_type === 1" label="规格列表：">
              <el-table ref="multipleSelection" size="small" :data="ManyAttrValue" tooltip-effect="dark" :row-key="(row) => { return row.id }" @selection-change="handleSelectionChange">
                ...
                <el-table-column v-if="formValidate.presell_type === 2" align="center" label="预售定金" min-width="80">
                  <template slot-scope="scope">
                    <el-input @input="handleInput(scope.row['down_price'],scope.$index)" :precision="2" size="small" v-model="scope.row['down_price']" type="number" class="priceBox" :min="0" :max="scope.row['price']*0.2" @blur="restrictedRange(scope.row)" />
                  </template>
                </el-table-column>
                <el-table-column v-if="formValidate.presell_type === 2" align="center" label="尾款" min-width="80">
                  <template slot-scope="scope">
                ...
                <el-table-column align="center" label="限量" min-width="80">
                  <template slot-scope="scope">
                    <el-input v-model.number="scope.row['stock']" type="number" size="small" class="priceBox" :min="0" :max="scope.row['old_stock']" />
                  </template>
                </el-table-column>
                <el-table-column align="center" label="商品编号" min-width="80">
                  <template slot-scope="scope">
