        ...
        <div v-show="currentTab === 1">
          ...
          <el-row :gutter="24">
            <el-col class="sp100">
              <el-form-item label="助力活动简介：" prop="store_info">
                <el-input v-model="formValidate.store_info" size="small" type="textarea" :rows="3" placeholder="请输入助力活动简介" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24">
            ...
            <el-col v-bind="grid2">
              <el-form-item label="助力人数：" prop="assist_count">
                <el-input-number v-model.number="formValidate.assist_count" size="small" :min="1" placeholder="请输入人数" />
              </el-form-item>
            </el-col>
            <el-col v-bind="grid2">
              <el-form-item label="用户助力次数：" prop="assist_user_count">
                <el-input-number v-model.number="formValidate.assist_user_count" size="small" :min="1" placeholder="请输入次数" />
              </el-form-item>
            </el-col>
            <el-col v-bind="grid2">
            ...
            <el-col v-bind="grid2">
              <el-form-item label="限购：">
                <el-input-number v-model="formValidate.pay_count" size="small" :min="1" placeholder="请输入限购数" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24">
            ...
            <el-col v-if="labelList.length" :span="24">
              <el-form-item label="商品标签：">
                <el-select v-model="formValidate.mer_labels" size="small" multiple placeholder="请选择" class="selWidthd">
                  <el-option
              ...
              <el-form-item v-if="formValidate.spec_type === 0" label="规格列表：">
                <el-table :data="OneattrValue" border class="tabNumWidth" size="small">
                  ...
                  <el-table-column align="center" label="助力价" min-width="80">
                    <template slot-scope="scope">
                      <el-input v-model="scope.row['assist_price']" type="number" size="small" class="priceBox" :min="0" :max="scope.row['price']" @blur="limitPrice(scope.row)" />
                    </template>
                  </el-table-column>
                  ...
                  <el-table-column align="center" label="限量" min-width="80">
                    <template slot-scope="scope">
                      <el-input v-model="scope.row['stock']" type="number" size="small" class="priceBox" :max="scope.row['old_stock']" :min="0" />
                    </template>
                  </el-table-column>
          ...
          <el-row :gutter="24">
            <el-form-item v-if="formValidate.spec_type === 1" label="规格列表：">
              <el-table ref="multipleTable" :data="ManyAttrValue" tooltip-effect="dark" size="small" highlight-current-row :row-key="(row) => { return row.id }">
                ...
                <el-table-column align="center" label="助力价" min-width="80">
                  <template slot-scope="scope">
                    <el-input v-model=" scope.row['assist_price']" type="number" size="small" class="priceBox" :min="0" :max="scope.row['price']" />
                  </template>
                </el-table-column>
                <el-table-column align="center" label="成本价" min-width="80">
                  <template slot-scope="scope">
                ...
                <el-table-column align="center" label="限量" min-width="80">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row['stock']" type="number" size="small" class="priceBox" :min="0" :max="scope.row['old_stock']" />
                  </template>
                </el-table-column>
                <el-table-column align="center" label="商品编号" min-width="80">
                  <template slot-scope="scope">
