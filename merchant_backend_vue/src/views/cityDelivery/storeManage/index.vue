<template>
  <div class="divBox">
    <div class="selCard">
      <el-form :model="tableFrom" ref="searchForm" size="small" label-width="90px" inline>         
        ...
        <el-form-item label="发货点名称：" prop="station_name">  
          <el-input v-model="tableFrom.station_name" placeholder="请输入发货点名称" class="selWidth" clearable @keyup.enter.native="getList(1)" />
        </el-form-item>  
        <el-form-item label="关键字：" prop="keyword">
          <el-input v-model="tableFrom.keyword" placeholder="请输入联系人姓名或电话" class="selWidth" clearable @keyup.enter.native="getList(1)" />
        </el-form-item>
        <el-form-item>
    ...
    <el-card class="mt14">
      <el-button size="small" type="primary" class="mb20" @click="add">添加发货点</el-button>
