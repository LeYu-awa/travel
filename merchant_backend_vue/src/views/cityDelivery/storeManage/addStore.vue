<template>
  ...
  >
    <div class="description">
      <div>
         <el-form size="small" :model="formValidate" ref="formValidate" :rules="rules"  label-width="110px">         
          <el-form-item label="发货点名称：" prop="station_name">  
            <el-input v-model="formValidate.station_name" placeholder="请输入发货点名称" class="width100" />
          </el-form-item>
          <el-form-item label="配送品类：" prop="business">
            <el-select v-model="formValidate.business" placeholder="请选择" class="width100" clearable>
              <el-option v-for="item in categoryList" :label="item.label" :value="item.key" />
            </el-select>
          </el-form-item>  
          <el-form-item label="所属城市：" prop="city_name">      
            <el-select v-model="formValidate.city_name" placeholder="请选择" class="width100" filterable clearable>
          ...
          <el-form-item label="发货点地址：" prop="station_address">
            <el-input v-model="formValidate.station_address" placeholder="请输入发货点地址" class="width100" />
          </el-form-item> 
          ...
          <el-form-item label="联系人姓名：" prop="contact_name">
            <el-input v-model="formValidate.contact_name" placeholder="请输入联系人姓名" class="width100" />
          </el-form-item>
          <el-form-item label="联系人电话：" prop="phone">
            <el-input v-model="formValidate.phone" placeholder="请输入联系人电话" class="width100" />
          </el-form-item>
          <el-form-item label="联系人身份证：">
            <el-input v-model="formValidate.id_card" placeholder="请输入联系人身份证" class="width100" />
          </el-form-item>
          <el-form-item v-if="deliveryType == 1" label="达达商家app账号：" required>
            <el-input v-model="formValidate.username" placeholder="请输入app账号(必须是手机号)" class="width100" />
          </el-form-item> 
          <el-form-item v-if="deliveryType == 1" label="达达商家app密码：" required>
              <el-input v-model="formValidate.password"  placeholder="请输入商家app密码" class="width100" />
          </el-form-item>
