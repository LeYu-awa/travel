    ...
    <div class="selCard">
      <el-form :model="tableFrom" ref="searchForm" size="small" label-width="85px" inline>
        <el-form-item label="管理员ID：" prop="admin_id">  
          <el-input v-model="tableFrom.admin_id" placeholder="请输入管理员ID" class="selWidth" @keyup.enter.native="getList(1)" />
        </el-form-item>
        <el-form-item label="请求方式：" prop="method">  
          <el-select v-model="tableFrom.method" placeholder="请选择" clearable class="selWidth" @change="getList(1)">
