                            ...
                            <div class="scrollCon">
                                <div style="width: 400px;margin: 0 auto">
                                    ...
                                    <div class="store-home">
                                        <div class="header">
                                            <div class="head-menu">
                                                <div class="iconfont-h5 icon-xiangzuo" style="color: #fff;"></div>
                                                <div class="iconfont-h5 icon-shouye4" style="color: #fff;"></div>
                                            </div>
                                            <div class="search"><span class="iconfont-h5 icon-xiazai5"></span>搜索商品</div>
                                        </div>
                                        <div class="store">
                                            <image src="@/assets/images/mer_avatar.png"></image>
                                            <div class="text">
                                                <div>
                                                    <span class="font-bg-red">自营</span>
                                                    <span class="name">店铺名称</span>
                                                    <span class="iconfont-h5 icon-xiangyou"></span>
                                                </div>
                                                <div class="score">
                                                    <div class="star">
                                                        <div></div>
                                            ...
                                            <div class="kefu">
                                                <span class="iconfont-h5 icon-kefu3"></span>
                                            </div>
                                            <div class="care button">
                                                <span class="iconfont-h5 icon-guanzhu"></span>
                                                关注
                                            </div>
                                        </div>
                                        <div class="nav">
                                            <div class="nav-cont">
                                                <div class="item active">
                                                    <div class="cont">精选</div>
                                                </div>
                                                <div class="item">
                                                    <div class="cont">新品</div>
                                                </div>
                                                <div class="item">
...
// +----------------------------------------------------------------------
import {diyGetInfo, diySave, getUrl} from "@/api/diy";
...
export default {
    ...
    computed: {
        ...mapState({
            titleTxt: (state) => state.mobildConfig.pageTitle || "店铺首页",
