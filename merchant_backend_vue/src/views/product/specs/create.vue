          ...
          <div class="demo-input-suffix acea-row">
            <el-form label-width="120px" :rules="ruleValidate" :model="formValidate" ref="formValidate">
              <el-form-item label="参数模板名称：" prop="template_name">
                <el-input v-model="formValidate.template_name" size="small" placeholder="请输入参数模板名称" class="selWidth" />
              </el-form-item>
              <el-form-item label="排序：">
                <el-input-number :min="0" size="small" v-model="formValidate.sort" label="排序" />
              </el-form-item>
              <el-form-item label="">
                <el-table
                  :data="data"
                ...
                >
                  ...
                  <el-table-column label="操作" min-width="120">
                    <template slot-scope="scope">
                      <el-button type="text" class="submission" size="small" @click="delSpecs(scope.$index)">删除</el-button>
                    </template>
                  </el-table-column>
                </el-table>
              </el-form-item>
