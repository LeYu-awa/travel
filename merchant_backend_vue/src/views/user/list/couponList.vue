  ...
  <div class="divBox">
    ...
    >
      ...
      <el-table-column label="操作" min-width="90" fixed="right">
        <template slot-scope="scope">
          <el-button type="text" size="small" :disabled="multipleSelection.coupon_id != scope.row.coupon_id" @click="send(scope.row.coupon_id)">发送</el-button>
        </template>
      </el-table-column>
    </el-table>
...
// +----------------------------------------------------------------------
import { couponIssueListApi,couponSendApi } from '@/api/marketing'
