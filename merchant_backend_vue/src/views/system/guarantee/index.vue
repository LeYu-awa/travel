<template>
  <div class="divBox">
    <div class="selCard">
      <el-form :model="tableFrom" ref="searchForm" inline size="small" clearable label-width="85px" @submit.native.prevent>
    ...
    <el-card class="mt14 dataBox"> 
      <el-button size="small" type="primary" class="mb20" @click="add">添加服务说明模板</el-button>
