<template>
  <div class="divBox">
    <el-card>
      <el-button size="small" type="primary" class="mb20" @click="add">添加关键字</el-button>
      <el-table
      ...
      >
          ...
          <div >
            <div style="text-align: right;">
              ...
              <el-button type="primary" size="small" :loading="loading" @click="submenus('formValidate')">保存并发布</el-button>
            </div>
          </div>
      </el-dialog>
  </div>
