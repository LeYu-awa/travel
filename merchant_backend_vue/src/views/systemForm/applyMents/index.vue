          ...
          <el-row>
            ...
            <el-col v-if="formValidate.organization_type != 2401 && formValidate.organization_type != 2500">
              ...
              <el-form-item label="证件注册号：" required>
                <el-input v-model="formValidate.business_license_number" size="small" :min="15" :max="18" placeholder="请输入证件注册号,须为15位数字或 18位数字|大写字母" />
              </el-form-item>
              <el-form-item label="商户名称：" prop="merchant_name">
                <el-input v-model="formValidate.merchant_name" size="small" placeholder="请填写营业执照/登记证书的商家名称，2~110个字符，支持括号" />
              </el-form-item>
              <el-form-item label="经营者/法定代表人姓名：" prop="legal_person">
                <el-input v-model="formValidate.legal_person" size="small" placeholder="请输入经营者/法定代表人姓名" />
              </el-form-item>
              <el-form-item label="注册地址：">
                <el-input v-model="formValidate.company_address" size="small" placeholder="请填写登记证书的注册地址" />
              </el-form-item>
            ...
            <el-col>
              ...
              <el-form-item label="经营者/法人证件类型：" prop="id_doc_type">
                <el-select v-model="formValidate.id_doc_type" filterable size="small" placeholder="请选择" class="selWidth">
            ...
            <el-col v-if="formValidate.id_doc_type == 1">
              ...
              <el-form-item label="身份证姓名：" prop="id_card_name">
                <el-input v-model="formValidate.id_card_name" size="small" placeholder="请输入经营者/法定代表人对应身份证的姓名" />
              </el-form-item>
              <el-form-item label="身份证号码：" prop="id_card_number">
                <el-input v-model="formValidate.id_card_number" :min="15" :max="18" size="small" placeholder="请输入经营者/法定代表人对应身份证的号码" />
              </el-form-item>
              ...
              <el-form-item v-if="formValidate.organization_type == 2" label="身份证居住地址:" prop="id_card_address">
                <el-input v-model="formValidate.id_card_address" size="small" placeholder="请输入身份证居住地址" />
              </el-form-item>
            </el-col>
            ...
            <el-col v-if="formValidate.id_doc_type != 1">
              ...
              <el-form-item label="证件姓名：" prop="id_doc_name">
                <el-input v-model="formValidate.id_doc_name" size="small" placeholder="请输入经营者/法人姓名" />
              </el-form-item>
              <el-form-item label="证件号码：" prop="id_doc_number">
                <el-input v-model="formValidate.id_doc_number" size="small" placeholder="请输入证件号码" />
              </el-form-item>
              ...
              <el-form-item label="证件居住地址:">
                <el-input v-model="formValidate.id_doc_address" size="small" placeholder="请输入证件居住地址" />
              </el-form-item>
            </el-col>
            <el-col>
              ...
              <el-form-item label="开户名称：" required>
                <el-input v-model="formValidate.account_name" size="small" placeholder="请输入开户名称" />
              </el-form-item>
              ...
              <el-form-item label="开户银行联行号：">
                <el-input v-model="formValidate.bank_branch_id" :max="64" size="small" placeholder="请输入开户银行联行号" />
              </el-form-item>
              <el-form-item label="开户银行全称 （含支行）：">
                <el-input v-model="formValidate.bank_name" :max="128" size="small" placeholder="请输入开户银行全称" />
              </el-form-item>
              <el-form-item label="银行帐号：" prop="account_number">
                <el-input v-model="formValidate.account_number" :maxlength="40" size="small" placeholder="请输入银行帐号" />
              </el-form-item>
            </el-col>
            <el-col>
              ...
              <el-form-item v-if="formValidate.contact_type == 66" label="超级管理员证件类型：">
                <el-select v-model="formValidate.contact_id_doc_type" filterable size="small" placeholder="请选择" class="selWidth">
                  <el-option label="中国大陆居民-身份证" value="1" />
              ...
              <el-form-item label="超级管理员姓名：" prop="contact_name">
                <el-input v-model="formValidate.contact_name" size="small" placeholder="请输入超级管理员姓名" />
              </el-form-item>
              <el-form-item label="超级管理员身份证件号码：" prop="contact_id_card_number">
                <el-input v-model="formValidate.contact_id_card_number" size="small" placeholder="请输入超级管理员身份证件号码" />
              </el-form-item>
              <el-form-item label="超级管理员手机：" prop="mobile_phone">
                <el-input v-model="formValidate.mobile_phone" size="small" placeholder="请输入超级管理员手机号" />
              </el-form-item>
              <el-form-item label="超级管理员邮箱：">
                <el-input v-model="formValidate.contact_email" size="small" placeholder="请输入超级管理员邮箱" />
              </el-form-item>
            </el-col>
            <!-- 店铺信息 -->
            <el-col>
              ...
              <el-form-item label="店铺链接：">
                <el-input v-model="formValidate.store_url" size="small" placeholder="请输入店铺链接" />
              </el-form-item>
              ...
              <el-form-item label="小程序AppID：">
                <el-input v-model="formValidate.mini_program_sub_appid" size="small" placeholder="请输入小程序AppID" />
              </el-form-item>
            </el-col>
            <el-col>
              <el-form-item label="商户简称：" prop="merchant_shortname">
                <el-input v-model="formValidate.merchant_shortname" size="small" type="textarea" placeholder="请输入商户简称" />
              </el-form-item>
            </el-col>
            <el-col>
            ...
            <el-col>
              <el-form-item label="补充说明：" :required="formValidate.organization_type == '2500'">
                <el-input v-model="formValidate.business_addition_desc" size="small" type="textarea" :max="512" placeholder="个人卖家主体请填写：该商户已持续从事电子商务经营活动满6个月，且期间经营收入累计超过20万元。" />
              </el-form-item>
            </el-col>
            <el-col v-if="message">
