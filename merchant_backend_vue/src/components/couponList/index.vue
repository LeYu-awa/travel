<template>
  <div class="divBox">
      ...
      <div class="container">
        <el-form inline size="small">
          <el-form-item label="优惠劵名称：">
            <el-input v-model="tableFrom.coupon_name" placeholder="请输入优惠券名称" @keyup.enter.native="getList" clearable class="selWidth" size="small" />
          </el-form-item>
          <el-form-item>
    ...
    >
      ...
      <el-table-column v-if="handle==='send'" label="操作" min-width="120" fixed="right">
        <template slot-scope="scope">
    ...
    <div>
      ...
      <el-button size="small" class="fr" @click="close">取消</el-button>
    </div>
  </div>
</template>
...
<style scoped lang="scss">
  ...
  ::v-deep .el-table thead tr,::v-deep .el-table thead th{
