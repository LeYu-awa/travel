<template>
  <div>
    <el-dialog :title="isEdit ? '编辑服务说明模板' : '添加服务说明模板'" :visible.sync="dialogVisible" width="1000px">
      <el-form ref="formValidate" class="formValidate mt20" :model="formValidate" :rules="ruleInline" label-width="90px">
        ...
        <el-form-item>
          ...
          <el-button type="primary" size="small" @click="getServiceTerms">搜索</el-button>
        </el-form-item>
        <el-form-item>
