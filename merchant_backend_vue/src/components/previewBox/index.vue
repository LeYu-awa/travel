<template>
  <div class="goods_detail">
    <div class="goods_detail_wrapper" :class="(previewKey || goodsId) ? 'on' : ''">
      <iframe v-if="previewKey" :src="'/pages/admin/goods_details/index?preview_key='+previewKey+'&product_type='+productType+'&inner_frame=1'" style="width: 100%;height:600px;" frameborder="0" />
