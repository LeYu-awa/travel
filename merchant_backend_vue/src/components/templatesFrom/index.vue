<template>
  <div>
    <el-form ref="ruleForm" v-loading="loading" :model="ruleForm" label-width="130px" size="small" :rules="rules">
      ...
      <el-form-item label="配送区域及运费：" prop="region">
        <el-table v-loading="listLoading" :data="ruleForm.region" border fit highlight-current-row size="small" class="tempBox">
          <el-table-column align="center" label="可配送区域" width="250">
          ...
          <el-table-column width="150" align="center" :label="columns.title">
            <template slot-scope="{row}">
              <el-input-number v-model="row.first" controls-position="right" :min="0" />
            </template>
          </el-table-column>
          <el-table-column width="150px" align="center" label="运费（元）">
            <template slot-scope="{row}">
              <el-input-number v-model="row.first_price" controls-position="right" :min="0" />
            </template>
          </el-table-column>
          <el-table-column width="150px" align="center" :label="columns.title2">
            <template slot-scope="{row}">
              <el-input-number v-model="row.continue" controls-position="right" :min="0.1" />
            </template>
          </el-table-column>
          <el-table-column class-name="status-col" align="center" label="续费（元）" width="150">
            <template slot-scope="{row}">
    ...
    <span class="footer acea-row">
      ...
      <el-button type="primary" size="small" @click="onsubmit('ruleForm')">确 定</el-button>
    </span>
  </div>
</template>
