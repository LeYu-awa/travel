			...
			<view class="main_counts">
				<form report-submit='true'>
					<view class="ChangePassword">
						...
						<!-- #ifdef MP -->
						<button v-if="!isCommuity && wechat_phone_switch == 1" form-type="submit" class="getPhoneBtn"
							open-type="getPhoneNumber" @getphonenumber="getPhoneNumber"><text
								class="iconfont icon-weixin2"></text>使用微信绑定号码</button>
							<!-- #endif -->
					</view>
				</form>
			</view>
