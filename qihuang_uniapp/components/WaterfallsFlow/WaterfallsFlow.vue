        ...
        <view>
            <view id="left" v-if="leftList.length">
                <view v-for="(item,index) in leftList" :key="index"
                    ...
                    <WaterfallsOrderFlowItem v-if="typePage === 'video'" :item="item" :isStore="isStore" :type="type" @goShop="goShop"/>
                    <WaterfallsFlowItem v-else :item="item" :isStore="isStore" :type="type" @goShop="goShop"/>
                </view>
            </view>
        </view>
        <!--    right    -->
...
import WaterfallsOrderFlowItem from '../WaterfallsOrderFlowItem/WaterfallsOrderFlowItem.vue'

export default {
    components: {
        WaterfallsFlowItem,
		WaterfallsOrderFlowItem
    },
    props: {
        // 瀑布流列表
        wfList: {
