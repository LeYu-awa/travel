...
export function updateUserProfile(data) {
	return request.post('updateUserProfile', data)
}
/**
 * 签到列表(年月)
 * @param object data
 ...
 * @param object data
 */
export function promotionCommissionLog(data) {
	return request.get('promotionCommissionLog/list', data);
}
/**
 * 
 * 推广佣金/提现总和
...
export function aiInit() {
	return request.get("user/ai/init", {}, { noVerify: true });
}
...
export function aiChat(data) {
	return request.post("user/ai/chat", data, { noVerify: true });
}

/**
 * AI 商品推荐
 */
export function aiProduct(data) {
	return request.post("user/ai/product", data, { noVerify: true });
}

/**
 * AI 文字转语音
 */
export function aiTts(data) {
	return request.post("user/ai/tts", data, { noVerify: true });
}
/**
 * 静默绑定推广人
 * @param {Object} puid
...
export function commissionTransfer(data) {
	return request.post('commission/transfer', data)
}
/*
	获取用户分销等级信息
*/
...
export function getCardWallet() {
	return request.get(`getCardWallet`)
}
// 赠送卡包
export function transferCard(data) {
	return request.post(`transferCard`, data)
}
// 获取用户个人资料
export function getUserProfile(data) {
	return request.get(`getUserProfile`,data)
}
//  获取粉丝列表
export function getMyFollowers(data) {
	return request.get(`getMyFollowers`, data)
}
//  获取关注列表
export function getMyFollowing(data) {
	return request.get(`getMyFollowing`, data)
}
//  创建直播视频订单
export function createLiveOrder(data) {
	return request.post(`createLiveOrder`, data)
}
//  获取用户订单列表
export function getUserAppointmentOrderList(data) {
	return request.get(`getUserAppointmentOrderList`, data)
}
//  删除直播视频订单
export function deleteLiveOrder(data) {
	return request.post(`memberCard/order/delete`, data)
}
//  取消直播视频订单
export function cancelLiveOrder(data) {
	return request.post(`memberCard/order/cancel`, data)
}
//  确认直播视频订单
export function confirmLiveOrder(data) {
	return request.post(`confirmLiveOrder`, data)
}

 // 获取我的作品列表 
export function getMyWorks(data) {
	return request.get("getMyWorks", data);
}


//  获取我的点赞列表
export function getMyLikes(data) {
	return request.get(`getMyLikes`, data)
}

//  获取我的收藏列表
export function getMyCollections(data) {
	return request.get(`getMyCollections`, data)
}
//  获取我的推荐列表
export function getRecommendVideoList(data) {
	return request.get(`getRecommendVideoList`, data)
}

//  获取用户作品列表
export function getUserWorks(data) {
	return request.get(`getUserWorks`, data)
}
//  获取直播视频订单列表
export function getLiveOrderList(data) {
	return request.get(`getLiveOrderList`, data)
}

//  获取视频卡、会员卡列表
export function getMemberCardList(data) {
	return request.get(`memberCard/list`, data)
}

//  获取视频卡、会员卡详情
export function getMemberCardDetail(data) {
	return request.get(`memberCard/detail`, data)
}
//  创建视频卡、会员卡
export function createMemberCard(data) {
	return request.post(`memberCard/order/create`, data)
}

//  获取视频卡、会员卡订单
export function getMemberOrder(data) {
	return request.get(`memberCard/order/list`, data)
}
//  再次支付视频卡、会员卡订单
export function repayMemberOrder(data) {
	return request.post(`memberCard/order/repay`, data)
}
//  获取海报
export function getSystemGroupData(data) {
	return request.get(`getSystemGroupData?group_data_id=225`, data)
}
//  优惠券
export function getCouponUserList(data) {
	return request.get(`getCouponUserList`, data)
}

//  消息数量
export function getMessageNum(data) {
	return request.get(`getMessageNum`, data)
}
