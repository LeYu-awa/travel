...
// }
export function graphicLstApi(data) {
	return request.get(`getVideoList`, data, {
		noAuth: true
	});
}
/**视频列表*/
...
/**关注人的文章列表*/
export function focusArticleLst(data) {
	return request.post(`getFollowedUsersWorks`, data, {
		noAuth: true
	});
}
/**用户的文章列表*/
...
// 短视频支付
export function createVideoOrder(data) {
	return request.get("createVideoOrder", data, {
		noAuth: true
	});
}
//订单号查询订单支付状态
export function getPayStatus(data) {
	return request.get("getPayStatus", data, {
		noAuth: true
	});
}

export function recommendVideo(data) {
	return request.post(`recommendVideo`, data);
}

export function cancelRecommendVideo(data) {
	return request.post(`cancelRecommendVideo`, data);
}
export function getVideoUploadId(data) {
	return request.post(`upload/getVideoUploadId`, data);
}
