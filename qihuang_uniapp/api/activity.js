...
export function getVoteList(data) {
	return request.get('vote/lst', data, {
		noAuth: true
	});
}
...
export function getVoteDetail(id) {
	return request.get(`vote/detail/${id}`, {}, {
		noAuth: true
	});
}
 ...
 * 投票选手列表
 */
export function getVotePlayerList(voteId, data) {
	return request.get(`vote/player/lst/${voteId}`, data, {
		noAuth: true
	});
}
 ...
 * 投票选手详情
 */
export function getVotePlayerDetail(id, data) {
	return request.get(`vote/player/detail/${id}`, data, {
		noAuth: true
	});
}
 ...
 * 投票排行榜
 */
export function getVoteRanking(voteId, data) {
	return request.get(`vote/ranking/${voteId}`, data, {
		noAuth: true
	});
}
 ...
 * 报名参加投票
 */
export function voteApply(voteId, data) {
	return request.post(`vote/apply/${voteId}`, data);
}

/**
 * 投票
 */
export function doVote(voteId, playerId, data) {
	return request.post(`vote/do/${voteId}/${playerId}`, data);
}

/**
 * 我的投票记录
 */
export function getMyVoteRecords(data) {
	return request.get('vote/my/records', data);
}

/**
 * 检查是否已报名
 */
export function checkVoteApply(voteId) {
	return request.get(`vote/check_apply/${voteId}`);
}

/**
 * 获取我的报名信息
 */
export function getMyVoteApply(voteId) {
	return request.get(`vote/my_apply/${voteId}`);
}