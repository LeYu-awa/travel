 ...
 * 
*/
export function getHotSector(data) {
  return request.get('getHotSector', data, { noAuth: true })
}
export function getHeadPageConfig(data) {
  return request.get('getHeadPageConfig', data, { noAuth: true })
}