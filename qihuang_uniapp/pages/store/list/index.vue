...
<script>
	import {getProductslist, getProductHot, getBrandlist, storeMerchantList, merchantProduct } from '@/api/store.js';
	import recommend from '@/components/recommend';
	import rightSlider from '@/components/rightSlidera.vue'
