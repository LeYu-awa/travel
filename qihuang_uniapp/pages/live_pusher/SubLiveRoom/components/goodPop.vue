		...
		<view class="popUp">
			...
			<view class="popUp-content">
				<scroll-view scroll-y="true" class="scroll-Y" :show-scrollbar="false">
					<view class="list" v-for="(item,ink) in list" :key="ink">
						<view class="list-image-box">
							<image class="list-image" mode="aspectFill" :src="item.image"></image>
							<view class="icon" v-if="item.is_show==1">上架中</view>
						</view>
						<view class="list-right">
							...
							<view class="list-right-bottom">
								...
								<view class="list-right-bottom-right">
									...
									<view class="sellOut" v-if="item.is_show==1" @click="ongood(item,ink)">下架</view>
									<view class="buying" v-else @click="ongood(item,ink)">上架</view>
