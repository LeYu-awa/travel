...
const state = {
	token: Cache.get(LOGIN_STATUS) || uni.getStorageSync('token') || '',
	...
	viewColor: '--view-theme: #19336B;--view-assist:#FF7612;--view-priceColor:#19336B;--view-bgColor:rgba(255, 118, 18,.1);--view-minorColor:#dce1ff;--view-bntColor11:#FDA923;--view-bntColor12:#FD6523;--view-bntColor21:rgba(38, 67, 127, 1);--view-bntColor22:rgba(38, 67, 127, 1);',
};

const mutations = {
	LOGIN(state, opt) {
		opt.token = opt.token || uni.getStorageSync('token') || ''
